...
```
docker run -d --name client-postgres --publish published=9501,target=80 -e PGADMIN_DEFAULT_PASSWORD=54321 -e PGADMIN_DEFAULT_EMAIL=admin@admin.com --network net-drupal dpage/pgadmin4
```
...
<img width="944" height="678" alt="image" src="https://github.com/user-attachments/assets/6cb86656-8c74-4ccd-90f2-59191084e1dc" />
<img width="912" height="956" alt="image" src="https://github.com/user-attachments/assets/117b6e9f-89fc-443a-8abb-614b4307a84a" />
<img width="888" height="962" alt="image" src="https://github.com/user-attachments/assets/007967f9-94cc-467e-bca3-981325de64ac" />


_La instalación puede tomar varios minutos, mientras espera realice un diagrama de los contenedores que ha creado en este apartado._

<img width="4975" height="1266" alt="Untitled diagram-2025-10-19-033627" src="https://github.com/user-attachments/assets/287888ea-0561-45fd-9bf6-9680bffb6f14" />


### Eliminar un volumen específico
```
docker volume rm vol-drupal-sites
```
**Considerar**
